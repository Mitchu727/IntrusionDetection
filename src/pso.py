...
def generate_population(population_size, number_of_attributes):
    return [generate_random_particle(number_of_attributes) for _ in range(population_size)], [generate_random_velocity(number_of_attributes) for _ in range(population_size)]
